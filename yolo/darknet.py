...
# Darknet里面convolutional都是conv2d+batchnorm+LeakyReLu
# 在此进行封装
...
'''
DarknetBasicBlockV3  用于darknet-53里面
YOLODetectionBlockV3 用于检测里面
YOLOOutputV3
'''
...
def get_darknet(darknet_version, num_layers, pretrained=False, ctx=mx.cpu(),
    ...
    pretrained : bool or str
        ...
        String value represents the hash tag for a certain version of pretrained weights.
